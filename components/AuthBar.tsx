...
const AuthBar = ({ id, email }: { id: string; email: string }) => {
  ...
  return (
    <Container>
      ...
      {isAuthMenuOpen && (
        <Modal>
          <MenuContainer open={isAuthMenuOpen} ref={setAuthMenu} left={13} bottom={32}>
            <Menu>
              <div id="menu-close">
      ...
      {isSettingsMenuOpen && (
        <Modal>
          <MenuContainer open={isSettingsMenuOpen} ref={setSettingsMenu} left={45} bottom={32}>
            <Menu>
              <div id="menu-close">
                <MenuButton
              ...
              <MenuItem>
                <RadioButton
                  role="menuitemradio"
                  onClick={() => handleThemeChange('autobiography')}
                >
