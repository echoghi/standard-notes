...
const NavItem = styled.button`
  ...
  span {
    ...
    color: ${(props: { active: boolean }) =>
      props.active ? 'var(--sn-stylekit-foreground-color);' : 'inherit'};
...
const Navigation = () => {
  ...
  const activeNoteColor =
    view === 'notes' ? 'var(--sn-stylekit-info-color)' : 'var(--sn-stylekit-neutral-color)';
  const activeArchiveColor =
    view === 'archived' ? 'var(--sn-stylekit-info-color)' : 'var(--sn-stylekit-neutral-color)';
  const activeTrashColor =
    view === 'deleted' ? 'var(--sn-stylekit-info-color)' : 'var(--sn-stylekit-neutral-color)';
